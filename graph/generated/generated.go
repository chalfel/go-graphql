...
func (ec *executionContext) field_Mutation_createDog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewDog2ᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createDog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Dog)
	fc.Result = res
	return ec.marshalNDog2ᚕᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDog2githubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalONewDog2ᚖgithubᚗcomᚋchalfelᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx context.Context, v interface{}) (*model.NewDog, error) {
	if v == nil {
		return nil, nil
	}
